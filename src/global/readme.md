...
@rhythm: 4px;
@radius: @rhythm; // 4px
@box-shadow: 0 -1px 1px fade(@base-primary, 2%), 0 1px 1px fade(@base-primary, 2%), 0 2px 2px fade(@base-primary, 2%), 0 4px 4px fade(@base-primary, 2%), 0 8px 8px fade(@base-primary, 2%), 0 16px 16px fade(@base-primary, 2%), 0 32px 32px fade(@base-primary, 2%);
